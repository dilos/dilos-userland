...
#PATH=/usr/bin:/usr/gnu/bin:/sbin:/usr/sbin
...
DOWNLOAD_SEARCH_PATH +=	$(ARCHIVE_MIRROR)
DILOS_ARCHIVE_MIRROR = http://www.dilos.org/srcarch
DOWNLOAD_SEARCH_PATH +=	$(DILOS_ARCHIVE_MIRROR)
...
deb:		SHELLOPTS=pipefail

SHELL=	/bin/bash

CONSOLIDATION =	dilos.org
...
#SPRO_VROOT =	$(SPRO_ROOT)/solstudio12.2
...
COMPONENT_BUILD_ENV += 		AWK="$(AWK)"
COMPONENT_BUILD_ENV += 		SED="$(GSED)"
COMPONENT_INSTALL_ENV += 	LC_ALL="C"
COMPONENT_INSTALL_ENV += 	AWK="$(AWK)"
COMPONENT_INSTALL_ENV += 	SED="$(GSED)"
...
GNU_ARCH64 =	$(PARCH64:sparcv9=sparcv9-sun)-solaris$(SOLARIS_VERSION)
...
.PHONY:	prep build install publish deb deb-clean test clean clobber

...
IMAP_DIR = $(WS_COMPONENTS)/php-5_2/imap/build/$(MACH32)
...
PHP_SAPI_BUILD = $(WS_COMPONENTS)/php-5_2/php-sapi/build/$(MACH32)
...
CPPFLAGS += -I/usr/include/curl
LIBS = -lsocket -lnsl -ldl -lposix4
LD = $(CXX) $($(COMPILER)_NORUNPATH)
LDFLAGS += -L$(MYSQL_LIBDIR) -lrt -L$(IMAP_CLIENT_DIR)

#CFLAGS += $(CC_PIC)
CFLAGS = -O1 -g $(CC_BITS) $(CC_PIC)
CXXFLAGS = -O1 -g $(CC_BITS) $(CC_PIC)
...
CONF_ENVLINE += \
	...
	PHP_PEAR_SIG_BIN=/usr/bin/gpg \
	DESTDIR=$(PROTO_DIR) \
	INSTALL_ROOT=$(PROTO_DIR) \
	INSTALL=$(INSTALL)

#PHP_ZTS_CFLAGS=-mt -D_REENTRANT
PHP_ZTS_CFLAGS=-D_REENTRANT
...
COMPONENT_BUILD_ENV += PATH="$(GCC_ROOT)/bin:$(PATH):/usr/sbin"
